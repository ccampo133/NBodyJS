 ...
 */
data class Body(val m: Double, val r: Double, val x: Vector, val v: Vector, var positions: List<Vector> = listOf(x)) {
  /**
  ...
  fun isCollision(other: Body): Boolean = (x minus other.x).len < other.r && this.m <= other.m
}
