# NBodyJS
##### A JavaScript and HTML5 implementation of a standard O(N<sup>2</sup>) N-body simulator, with a little bit of style and fun.
...
Copyright &copy; 2013 Christopher J. Campo. All Rights Reserved.